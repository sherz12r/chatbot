...
ADDITIONAL_RESPONSES = {
    ...
    "what's the weather like today?": "You can check the latest weather update for your location using a weather service.",
    "what's the capital of France?": "The capital of France is Paris.",
    "who is the president of the United States?": "The current president of the United States is [current president].",
    "what's 2 + 2?": "2 + 2 equals 4.",
    "tell me a joke": "Why don't skeletons fight each other? Because they don't have the guts!",
    "how do I bake a cake?": "To bake a cake, you'll need flour, sugar, eggs, butter, and baking powder. Mix the ingredients and bake at 350°F (175°C) for about 30 minutes.",
    ...
    "how do I say 'hello' in Spanish?": "You can say 'hello' in Spanish by saying 'Hola'.",
    ...
    "how do I lose weight?": "A balanced diet and regular exercise are key to healthy weight loss.",
    ...
    "how do I make coffee?": "To make coffee, brew ground coffee beans in hot water and filter the liquid.",
    "what's the largest ocean?": "The Pacific Ocean is the largest ocean on Earth.",
    "how do I meditate?": "Sit in a quiet place, focus on your breathing, and clear your mind.",
    "what's the longest river in the world?": "The Nile River is the longest river in the world.",
    "how does photosynthesis work?": "Plants use sunlight, carbon dioxide, and water to produce oxygen and glucose.",
    "who painted the Mona Lisa?": "Leonardo da Vinci painted the Mona Lisa.",
    "what's the formula for water?": "The chemical formula for water is H₂O.",
    "how do I learn a new language?": "Practice daily, use language learning apps, and converse with native speakers.",
    "what's the largest desert in the world?": "The Antarctic Desert is the largest desert in the world.",
    "how do airplanes fly?": "Airplanes fly using the principles of lift, thrust, drag, and gravity.",
    "what's the capital of Australia?": "The capital of Australia is Canberra.",
    "who is Elon Musk?": "Elon Musk is a billionaire entrepreneur and CEO of Tesla and SpaceX.",
    "how do I improve my memory?": "Practice mindfulness, eat brain-boosting foods, and get enough sleep.",
    "what's the meaning of life?": "The meaning of life is a philosophical question with many perspectives.",
    "how do I start a business?": "Start with a business plan, secure funding, and market your idea effectively.",
    "what's the currency of the UK?": "The currency of the UK is the British pound (GBP).",
    "who discovered America?": "Christopher Columbus is credited with discovering America in 1492.",
    "how do I reduce stress?": "Exercise, meditate, and get enough sleep to reduce stress.",
    "what's the coldest place on Earth?": "Antarctica is the coldest place on Earth.",
    "how do I cook pasta?": "Boil water, add pasta, and cook until it reaches your preferred texture.",
    "what's the population of the world?": "The current world population is approximately 8 billion.",
    "how do I grow tomatoes?": "Plant tomato seeds in well-drained soil with plenty of sunlight and water.",
    "who wrote 'Harry Potter'?": "J.K. Rowling wrote the 'Harry Potter' series.",
    "how does the stock market work?": "The stock market is a marketplace where investors buy and sell company shares.",
    "what's the national bird of the USA?": "The national bird of the USA is the bald eagle.",
    "how do I get fit?": "Regular exercise and a healthy diet are key to fitness.",
    ...
    "how do I learn to code?": "Start with beginner-friendly languages like Python and practice regularly.",
    "what's the capital of Germany?": "The capital of Germany is Berlin.",
    "how do I make a smoothie?": "Blend fruits, yogurt, and milk or juice to make a smoothie.",
    "what's the deepest ocean?": "The Pacific Ocean has the deepest point, the Mariana Trench.",
    "how do I clean my phone screen?": "Use a microfiber cloth and a small amount of water or screen cleaner.",
    "who invented the telephone?": "Alexander Graham Bell invented the telephone.",
    "what's the capital of Brazil?": "The capital of Brazil is Brasília.",
    "how do I change a tire?": "Loosen the lug nuts, lift the car, replace the tire, and tighten the nuts.",
    "what's the smallest country in the world?": "Vatican City is the smallest country in the world.",
    "how do I build a website?": "You can use HTML, CSS, and JavaScript, or a website builder like WordPress.",
    "who is the richest person in the world?": "The richest person in the world changes frequently based on net worth rankings.",
    "how do I improve my writing skills?": "Practice daily, read more, and use grammar tools.",
    "what's the fastest land animal?": "The cheetah is the fastest land animal.",
    "how do I boil an egg?": "Boil water, add eggs, and cook for 7-10 minutes.",
    "who won the last FIFA World Cup?": "The latest FIFA World Cup winner is [latest winner].",
    "how do I stay hydrated?": "Drink at least 8 glasses of water per day.",
    "what's the currency of China?": "The currency of China is the Chinese yuan (CNY).",
    "how do I tie a tie?": "Follow a simple knot like the Four-in-Hand or Windsor knot.",
    "who was Albert Einstein?": "Albert Einstein was a physicist known for the theory of relativity.",
    "what's the capital of Russia?": "The capital of Russia is Moscow.",
    "how do I cook rice?": "Rinse the rice, add water, and cook on low heat until soft.",
    "who discovered penicillin?": "Alexander Fleming discovered penicillin.",
    "how do I start a YouTube channel?": "Create an account, choose a niche, and start uploading videos.",
}
